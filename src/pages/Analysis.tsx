...
import { Watch, LineChart, Moon, Zap, Bed, Clock, ClipboardList, Send, UserSquare, X, ChevronRight, Activity, Flame, HeartPulse } from 'lucide-react';
             ...
             <div className="flex items-center gap-2 mb-6">
              ...
              {isSubmitted ? (
                 ...
                 >
                   ...
                   <p className="text-slate-400 text-sm">{t('submitDesc')}</p>
                 </motion.div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button 
                    type="submit"
                    className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-4 rounded-xl transition-colors mt-4 flex items-center justify-center gap-2 shadow-lg shadow-indigo-600/20"
                  >
                    <Send size={18} />
                    {t('submit')}
                  </button>

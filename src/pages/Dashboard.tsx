...
export default function Dashboard() {
	...
	// USE THE HOOK INSTEAD OF STATIC MOCK DATA
	const { data, isLoading } = useHealthData(connectedDevice);

	// Show a loading state while fetching/evaluating
	if (isLoading) {
		return <div className="min-h-screen flex items-center justify-center text-slate-400">Loading data...</div>;
	}
